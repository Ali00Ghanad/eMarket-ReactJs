  ...
  return (
    <div className='flex flex-col gap-32 w-full'>
      ...
      <div className='w-full'>
        <Slider className=' cursor-pointer h-[300px] bg-black ' {...bannerSetting}>
          {
      ...
      <section>
        ...
        <div className='flex flex-col items-center'>
          <ProductSlider products={allProducts.filter(item => item.price < 20)} />
      ...
      <section>
        ...
        <div className='flex flex-col items-center'>
          <ProductSlider products={allProducts.filter(item => item.rating.rate > 3)} />
        </div>

      </section>


      <div className='flex items-center justify-between bg-black p-[50px]'>
