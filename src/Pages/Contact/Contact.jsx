...
const Contact = () => {
    return (
        <div className='flex items-stretch w-full gap-x-7'>

            <div className='flex flex-col shadow-lg px-8 py-10 w-[30%] rounded-[10px] border border-slate-200'>
            ...
            <div className='flex items-center justify-center px-8 py-10 shadow-lg border border-slate-200 w-[70%] rounded-[10px]'>
